@extends('layouts.app')
@section('content')
<div class="flex items-center justify-center min-h-[calc(100vh-120px)] bg-blue-50">
  <form action="{{ url('tourtext') }}" method="POST" class="bg-yellow-50 backdrop-blur-sm p-8 rounded-2xl shadow-lg w-full max-w-lg">
    @csrf
